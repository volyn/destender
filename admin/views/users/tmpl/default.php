...
if ( $saveOrder ) {
	$saveOrderingUrl = 'index.php?option=com_projects&task=users.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_( 'index.php?option=com_projects&view=users' ); ?>" method="post" name="adminForm" id="adminForm">
		...
		<div id="j-main-container">
			...
			<table class="table table-striped" id="articleList">
				...
				<?php foreach ( $this->items as $i => $item ) :
					...
					$canEdit = $user->authorise( 'core.edit', '#__userstypes.' . $item->id );
					$canCheckin = $user->authorise( 'core.manage', 'com_projects' ) || $item->checked_out == $userId || $item->checked_out == 0;
					$canEditOwn = $user->authorise( 'core.edit.own', '#__userstypes.' . $item->id ) && $item->created_by == $userId;
					$canChange = $user->authorise( 'core.edit.state', '#__userstypes.' . $item->id ) && $canCheckin;
					?>
						...
						<td class="nowrap has-context">
							<div class="pull-left">
								<?php if ( $canEdit || $canEditOwn ) : ?>
									<a href="<?php echo JRoute::_( 'index.php?option=com_projects&task=user.edit&id=' . $item->id ); ?>" title="<?php echo JText::_( 'JACTION_EDIT' ); ?>">
